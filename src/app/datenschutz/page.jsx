  ...
  return (
    <div className={styles.container}>
      <div className={styles.items}>
        <h1 className={styles.h1}>Datenschutz&shy;erkl&auml;rung</h1>
        ...
        <h4 className={styles.h4}>Wie erfassen wir Ihre Daten?</h4>
        <p>
        ...
        <h4 className={styles.h4}>Wof&uuml;r nutzen wir Ihre Daten?</h4>
        <p>
        ...
        <h4 className={styles.h4}>Auftragsverarbeitung</h4>
        <p>
        ...
        <h3 className={styles.h3}>Auskunft, Berichtigung und L&ouml;schung</h3>
        <p>
        ...
        <h3 className={styles.h3}>SSL- bzw. TLS-Verschl&uuml;sselung</h3>
        <p>
        ...
        <h3 className={styles.h3}>Kontaktformular</h3>
        <p>
        ...
        <h3 className={styles.h3}>Anfrage per E-Mail, Telefon oder Telefax</h3>
        <p>
        ...
        <h2 className={styles.h2}>5. Plugins und Tools</h2>
        <h3 className={styles.h3}>Google Fonts (lokales Hosting)</h3>
        <p>
